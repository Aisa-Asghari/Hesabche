...
public class AboutActivity extends DrawerActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ActivityCompat.checkSelfPermission(AboutActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            ...
            ActivityCompat.requestPermissions(AboutActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 44);
        }
    }
                ...
                if (location != null) {
                    supportMapFragment.getMapAsync(new OnMapReadyCallback() {
                        ...
                        public void onMapReady(GoogleMap googleMap) {
                            LatLng latLng = new LatLng(35.6203318, 51.3966033);
